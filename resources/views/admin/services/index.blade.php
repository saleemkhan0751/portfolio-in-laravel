...
@section("content")
        ...
        <div class="col-md-12">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">@isset($service) Update Service @else Create Service @endisset</h5>
                ...
                <div class="panel-body">
                    @if(!isset($service))
                        {{ Form::open(['route' => ['services.store'],'files' => true,'class' => 'form-horizontal']) }}
                    @else
                        {{ Form::model($service, ['route' => ['services.update', $service->id], 'class' => 'form-horizontal']) }}
                        {{ method_field('PATCH') }}
                    @endif
                    <div class="row">
                    ...
                    <div class="row ">
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 text-right mt-28">
                            <button type="submit" class="btn bg-slate-700">@isset($service) Update @else Create @endisset</button>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title text-semibold">List Service </h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                            <li><a data-action="close"></a></li>
